...
### 🤖 Multi-Turn RAG Chatbot with Conversational Memory & Semantic Retrieval
...
**Tech Stack:** Python, LLM APIs, Vector Embeddings, FAISS

---

### 📈 Relay CRM — AI-Assisted SaaS CRM Dashboard
...
### 🏭 IoT-Based Industrial Machine Health Monitoring and Control
- Real-time sensor fusion for vibration, temperature, and current detection
- ML-based predictive anomaly detection achieving **92% accuracy**; reduced breakdown risk by 30%

**Tech Stack:** ESP8266, Python, MQTT, InfluxDB, Grafana, DHT11, MPU6050

---

### 🔎 FAQ Semantic Search Engine using RAG
- RAG-architecture semantic search enabling precise natural-language querying of knowledge bases
- Reduced average query resolution time by **60%** vs keyword-based search

**Tech Stack:** Python, RAG, Embeddings, FAISS, REST APIs
